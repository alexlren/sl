...
# define TRAIN_FRAME_WIDTH      83
# define TRAIN_FRAME_HEIGHT     17
# define TRAIN_FRAME_COUNT      6

static const char *__train_orig_frame[TRAIN_FRAME_HEIGHT] = {
    "                       (@@) (  ) (@)  ( )  @@    ()    @     O     @     O      @  ",
    "                  (   )                                                            ",
    "              (@@@@)                                                               ",
    "           (    )                                                                  ",
...
static struct animation_frame_update_list __train_fru_list__[TRAIN_FRAME_COUNT - 1] = {
...
static struct animation train_animation = {
    .width = TRAIN_FRAME_WIDTH,
    .height = TRAIN_FRAME_HEIGHT,
